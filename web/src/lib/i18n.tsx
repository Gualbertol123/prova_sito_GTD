...
const IT: Dict = {
  ...
  "gr.stat.projects": "Avanzamento medio progetti",
  "gr.stat.closeRate": "Chiuso",
  "gr.stat.closeRateNote": "Completate sul totale del lavoro attivo (completate + in corso + prossime).",
...
const EN: Dict = {
  ...
  "gr.stat.projects": "Average project progress",
  "gr.stat.closeRate": "Closed",
  "gr.stat.closeRateNote": "Completed out of all active work (completed + in progress + next).",
