...
const IT: Dict = {
  ...
  "auth.noEmail": "Sito non configurato: manca VITE_TEAM_EMAIL (l'e-mail dell'account del team) nelle variabili di Netlify.",

  "authr.ok": "OK.",
  "authr.wrong": "Password errata.",
  "authr.locked": "Troppi tentativi errati: riprova tra 5 minuti.",
  "authr.unknown": "Questo nome non è nell'elenco dei membri.",
  "authr.invalid": "La nuova password non è valida (da 6 a 72 caratteri).",
  "authr.forbidden": "Questo account non è autorizzato per la bacheca.",
  "authr.rateLimited": "Troppi tentativi: attendi qualche minuto e riprova.",
  "authr.notTeam": "Questo account non è nell'elenco del team (vedi README → Sicurezza).",
  "authr.notUpgraded": "Il database non è ancora aggiornato: esegui migration-011-auth-step1.sql su Supabase.",
  "authr.failed": "Impossibile completare l'operazione. Controlla la connessione e riprova.",
  "authr.unsupported": "Un'impostazione di Supabase impedisce l'accesso (CAPTCHA, MFA o e-mail non confermata): vedi README §11.",
  ...
  "settings.teamPassword": "Password del team",
  "settings.pwdCurrent": "Password attuale",
  "settings.pwdNew": "Nuova password (almeno 12 caratteri)",
  "settings.pwdConfirm": "Ripeti la nuova password",
  "settings.pwdHint": "Tutti gli altri dispositivi verranno disconnessi e dovranno usare la nuova password. Password dimenticata? Un amministratore la reimposta da Supabase.",
  "settings.pwdTooShort": "La nuova password deve avere almeno 12 caratteri.",
  "settings.pwdMismatch": "Le due nuove password non coincidono.",
  "settings.pwdChanged": "Password del team cambiata ✓ Gli altri dispositivi verranno disconnessi.",
  "settings.pwdWrongCurrent": "La password attuale non è corretta.",
  "settings.pwdRejected": "Supabase ha rifiutato la nuova password:",
  "settings.loginDuration": "Durata accesso (giorni)",
  "settings.save": "Salva",
  "settings.saved": "Salvato ✓",
  "settings.migrationNote": "La durata dell'accesso vale dal prossimo accesso su ciascun dispositivo.",
  ...
  "report.title": "Report settimanale",
  "report.hint": "Report in Liquid Glass: generalo, modifica qualsiasi testo direttamente sulle pagine, poi scarica il PDF.",
  "report.generate": "Genera report",
  "report.downloadWordClassic": "Word (modello classico)",
  "report.downloadPdf": "Scarica PDF",
  "report.pdfMaking": "Creazione del PDF…",
  "report.reset": "Ripristina",
  "report.resetHint": "Annulla tutte le modifiche a questo report e riparti dalla bacheca",
  "report.resetConfirm": "Annullare tutte le modifiche al report di questa settimana (testi, schede nascoste, attività in evidenza)?",
  "report.draftSaved": "Modifiche salvate su questo dispositivo per 7 giorni: puoi cambiare pagina e ritrovarle qui.",
  "report.pdfLogin": "Accesso scaduto: esci e rientra, poi riprova.",
  "report.close": "Chiudi report",
  "report.editHint": "Clicca su qualsiasi testo per modificarlo · passa sopra una scheda e premi × per toglierla dal report",
  ...
  "gr.cover.eyebrow": "Report settimanale",
  "gr.cover.title": "La settimana, in chiaro.",
  "gr.cover.subtitle": "Cosa abbiamo chiuso, cosa arriva adesso e a che punto sono i progetti.",
  "gr.cover.noteTitle": "In sintesi",
  "gr.cover.highlights": "In evidenza",
  "gr.pick.open": "Scegli attività",
  "gr.pick.done": "Fatto",
  "gr.pick.title": "In evidenza: {n} di {max}",
  "gr.pick.doneGroup": "Completate nel periodo",
  "gr.pick.empty": "Nessuna attività in evidenza: premi «Scegli attività» per sceglierle (questo riquadro non va nel PDF finché è vuoto).",
  "gr.cover.note": "Scrivi qui due righe sulla settimana: i risultati principali, cosa è cambiato, dove serve attenzione.",
  "gr.stat.done": "Attività completate",
  "gr.stat.subtasks": "Sotto-attività chiuse",
  "gr.stat.inProgress": "In corso",
  "gr.stat.next": "Prossime",
  "gr.stat.waiting": "In attesa",
  "gr.sec.done.eyebrow": "Completate",
  "gr.sec.done.title": "Fatto questa settimana",
  "gr.sec.done.empty": "Nessuna attività completata in questo periodo.",
  "gr.sec.next.eyebrow": "Prossimi passi",
  "gr.sec.next.title": "Cosa arriva adesso",
  "gr.sec.next.empty": "La colonna Next è vuota.",
  "gr.sec.projects.eyebrow": "Progetti",
  "gr.sec.projects.title": "Progetti in corso",
  "gr.sec.projects.empty": "Nessun progetto aperto.",
  "gr.sec.planner.eyebrow": "Planner",
  "gr.sec.planner.title": "La bacheca, oggi",
  "gr.sec.planner.empty": "La bacheca è vuota.",
  "gr.sec.retro.eyebrow": "Retrospettiva",
  "gr.sec.retro.title": "Cosa ci portiamo dietro",
  "gr.sec.retro.empty": "Nessuna voce nella revisione settimanale.",
  "gr.retro.well": "Successi",
  "gr.retro.learnings": "Cosa abbiamo imparato",
  "gr.retro.improve": "Da migliorare",
  "gr.retro.blockers": "Ostacoli",
  "gr.retro.focus": "Focus della prossima settimana",
  "gr.retro.write": "Scrivi qui… (se resta vuoto, questo riquadro non va nel PDF)",
  "gr.completedOn": "completata il",
  "gr.due": "Scadenza",
  "gr.more": "+{n} altre",
  "gr.untitled": "Progetto senza nome",
  "gr.bandEmpty": "Niente in questa colonna.",
  "gr.hide": "Togli dal report",
  "gr.footer": "Report settimanale",
  ...
  "reflAuth.hint": "I nuovi membri partono con la password «password»: cambiala subito qui sotto dopo il primo accesso.",
  ...
  "reflAuth.currentPassword": "Password attuale",
  "reflAuth.wrongCurrent": "La password attuale non è corretta.",
  "reflAuth.newHint": "Da 6 a 72 caratteri. Password dimenticata? Chiedi a un amministratore di reimpostarla.",
...
const EN: Dict = {
  ...
  "auth.noEmail": "Site not configured: VITE_TEAM_EMAIL (the team account's e-mail) is missing from the Netlify variables.",

  "authr.ok": "OK.",
  "authr.wrong": "Wrong password.",
  "authr.locked": "Too many wrong attempts: try again in 5 minutes.",
  "authr.unknown": "That name is not on the member list.",
  "authr.invalid": "The new password is not valid (6 to 72 characters).",
  "authr.forbidden": "This account is not allowed to use the board.",
  "authr.rateLimited": "Too many attempts: wait a few minutes and try again.",
  "authr.notTeam": "This account is not on the team list (see README → Security).",
  "authr.notUpgraded": "The database is not upgraded yet: run migration-011-auth-step1.sql in Supabase.",
  "authr.failed": "Could not complete that. Check the connection and try again.",
  "authr.unsupported": "A Supabase setting blocks the login (CAPTCHA, MFA or unconfirmed e-mail): see README §11.",
  ...
  "settings.teamPassword": "Team password",
  "settings.pwdCurrent": "Current password",
  "settings.pwdNew": "New password (at least 12 characters)",
  "settings.pwdConfirm": "Repeat the new password",
  "settings.pwdHint": "Every other device will be logged out and must use the new password. Forgotten it? An admin resets it from Supabase.",
  "settings.pwdTooShort": "The new password needs at least 12 characters.",
  "settings.pwdMismatch": "The two new passwords do not match.",
  "settings.pwdChanged": "Team password changed ✓ Other devices will be logged out.",
  "settings.pwdWrongCurrent": "The current password is not correct.",
  "settings.pwdRejected": "Supabase refused the new password:",
  "settings.loginDuration": "Login duration (days)",
  "settings.save": "Save",
  "settings.saved": "Saved ✓",
  "settings.migrationNote": "A new login duration applies from each device's next login.",
  ...
  "report.hint": "Liquid Glass report: generate it, edit any text right on the pages, then download the PDF.",
  "report.generate": "Generate report",
  "report.downloadWordClassic": "Word (classic template)",
  "report.downloadPdf": "Download PDF",
  "report.pdfMaking": "Making the PDF…",
  "report.reset": "Reset",
  "report.resetHint": "Undo every change to this report and start again from the board",
  "report.resetConfirm": "Undo every change to this week's report (texts, hidden cards, highlights)?",
  "report.draftSaved": "Changes saved on this device for 7 days: you can leave the page and find them here.",
  "report.pdfLogin": "Your login has expired: log in again, then retry.",
  "report.close": "Close report",
  "report.editHint": "Click any text to edit it · hover a card and press × to leave it out of the report",
  ...
  "gr.cover.eyebrow": "Weekly report",
  "gr.cover.title": "The week, at a glance.",
  "gr.cover.subtitle": "What we closed, what comes next, and where the projects stand.",
  "gr.cover.noteTitle": "In short",
  "gr.cover.highlights": "Highlights",
  "gr.pick.open": "Choose tasks",
  "gr.pick.done": "Done",
  "gr.pick.title": "Highlights: {n} of {max}",
  "gr.pick.doneGroup": "Completed in the period",
  "gr.pick.empty": "No highlights yet: press “Choose tasks” to pick them (this box stays out of the PDF while empty).",
  "gr.cover.note": "Write a couple of lines about the week here: the main results, what changed, where attention is needed.",
  "gr.stat.done": "Tasks completed",
  "gr.stat.subtasks": "Subtasks closed",
  "gr.stat.inProgress": "In progress",
  "gr.stat.next": "Up next",
  "gr.stat.waiting": "Waiting",
  "gr.sec.done.eyebrow": "Completed",
  "gr.sec.done.title": "Done this week",
  "gr.sec.done.empty": "Nothing was completed in this period.",
  "gr.sec.next.eyebrow": "Next steps",
  "gr.sec.next.title": "What comes next",
  "gr.sec.next.empty": "The Next column is empty.",
  "gr.sec.projects.eyebrow": "Projects",
  "gr.sec.projects.title": "Projects in flight",
  "gr.sec.projects.empty": "No open projects.",
  "gr.sec.planner.eyebrow": "Planner",
  "gr.sec.planner.title": "The board, today",
  "gr.sec.planner.empty": "The board is empty.",
  "gr.sec.retro.eyebrow": "Retrospective",
  "gr.sec.retro.title": "What we take with us",
  "gr.sec.retro.empty": "No items in the weekly review.",
  "gr.retro.well": "Wins",
  "gr.retro.learnings": "Learnings",
  "gr.retro.improve": "To improve",
  "gr.retro.blockers": "Blockers",
  "gr.retro.focus": "Focus next week",
  "gr.retro.write": "Write here… (left empty, this box stays out of the PDF)",
  "gr.completedOn": "completed",
  "gr.due": "Due",
  "gr.more": "+{n} more",
  "gr.untitled": "Untitled project",
  "gr.bandEmpty": "Nothing in this column.",
  "gr.hide": "Leave out of the report",
  "gr.footer": "Weekly report",
  ...
  "reflAuth.hint": "New members start with the password “password”: change it right after your first login.",
  ...
  "reflAuth.currentPassword": "Current password",
  "reflAuth.wrongCurrent": "The current password is not correct.",
  "reflAuth.newHint": "6 to 72 characters. Forgotten it? Ask an admin to reset it.",
