...
const IT: Dict = {
  ...
  "report.pdfHint": "Il PDF si scarica così com’è nell’editor. Il testo è un’immagine: per un PDF con testo selezionabile, scarica il Word e usa «Salva come PDF» di Word.",
...
const EN: Dict = {
  ...
  "report.pdfHint": "The PDF downloads exactly as it looks in the editor. Its text is an image; for a PDF with selectable text, download the Word file and use Word’s “Save as PDF”.",
